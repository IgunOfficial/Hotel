...
<html lang="en">
  <head>
    ...
    <title>Deluxe Room by Hotel Hebat</title>
  </head>
  <body>
  ...
  <!-- END NAVBAR -->
    ...
    <div class="row">
        <div class="col-md-6"> 
                <img src="../images/deluxe.jpg" class="img-fluid" alt="...">
        </div>

    </div>

    <h4>Deluxe Room</h4>
    <p>Tipe Kamar dengan dekor yang bernuansa Indonesia klasik, di setting senyaman mungkin untuk memanjakan pengunjung.</p>
