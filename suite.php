...
<html lang="en">
  <head>
    ...
    <title>Suite Room by Hotel Hebat</title>
  </head>
  <body>
      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
            ...
            <li><a class="dropdown-item" href="executive.php">Executive Room</a></li>
  ...
  <!-- END NAVBAR -->
    ...
    <div class="row">
        <div class="col-md-6"> 
                <img src="../images/suite2.jpg" class="img-fluid" alt="...">
        </div>

    </div>

    <h4>Suite Room</h4>
    <p>Rekomendasi tipe kamar untuk anda yang mencari kemewahan lebih dari deluxe, tetapi dengan budget yang masih terjangkau dan sesuai.
        Masih dengan permainan material dan corak kayu, menjadikan suite room ini tipe kamar yang sangat nyaman, ditambah lagi dengan view perkotaan yang dapat memanjakan mata.
    </p>
